    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.miaperblock))
          ...
          <Flex flexDirection={['column', null, null, 'row']} alignItems={['flex-end', null, null, 'center']} justifyContent="center">
            <Flex flexDirection="column" flex="1" alignSelf={['flex-start', null, null, 'center']}>
              ...
              <Flex>
                ...
                <Text ml="10px" fontSize="18px">{t('Deposit Fee will be used to buyback MIA')}</Text>
              </Flex>
            </Flex>
